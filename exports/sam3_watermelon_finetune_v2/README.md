# SAM 3 西瓜微调数据集（sam3_watermelon_finetune_v2）
...
6. 对基础 clean 拆分全量扫描灰度 D4 近重复：16×16 Bilinear、零均值 L2、corr ≥ 0.995 粗筛，再以同一 D4 在 128×128 确认 corr ≥ 0.995 且 SSIM ≥ 0.96；优先保留 test，其次 val，再隔离冲突 train 的完整 provenance scene。
...
ann_file: D:/MelonDataset/watermelon_seg/exports/sam3_watermelon_finetune_v2/annotations/instances_train_clean.json
coco_json_loader:
