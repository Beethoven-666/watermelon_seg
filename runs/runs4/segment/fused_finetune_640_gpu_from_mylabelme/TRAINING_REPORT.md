...
```text
D:/MelonDataset/watermelon_seg/runs/runs2/segment/my_labelme_finetune/weights/best.pt
```
...
C:\Users\zyh68\.conda\envs\melonvision\Scripts\yolo.exe segment train `
  model=D:/MelonDataset/watermelon_seg/runs/runs2/segment/my_labelme_finetune/weights/best.pt `
  data=D:/MelonDataset/watermelon_seg/data.yaml `
  imgsz=640 epochs=100 batch=16 device=0 workers=4 patience=25 seed=20260707 `
  project=D:/MelonDataset/watermelon_seg/runs/runs4/segment `
...
```text
D:/MelonDataset/watermelon_seg/runs/runs4/segment/fused_gpu_best_predict_test_640
```

评估图和曲线在：

```text
D:/MelonDataset/watermelon_seg/runs/runs4/segment/fused_finetune_640_gpu_from_mylabelme
D:/MelonDataset/watermelon_seg/runs/runs4/segment/fused_gpu_best_val_640
D:/MelonDataset/watermelon_seg/runs/runs4/segment/fused_gpu_best_test_640
```
